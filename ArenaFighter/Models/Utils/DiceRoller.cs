...
namespace ArenaFighter.Models.Utils {
    ...
    public static class DiceRoller {
        ...
        public static readonly Dictionary<Func<bool, int>, string> dieNames = new Dictionary<Func<bool, int>, string>() {
            [CoinFlip] = "1d2", [ThreeSidedDie] = "1d3", [FourSidedDie] = "1d4", [SixSidedDie] = "1d6", [EightSidedDie] = "1d8", [TenSidedDie] = "1d10", [TwelveSidedDie] = "1d12", [TwentySidedDie] = "1d20", [TwoDTwo] = "2d2", [TwoDThree] = "2d3", [TwoDFour] = "2d4", [TwoDSix] = "2d6",
        };
        public static readonly Dictionary<Func<bool, int>, double> averageRoll = new Dictionary<Func<bool, int>, double>() {
            [CoinFlip] = 1.5, [ThreeSidedDie] = 2.0, [FourSidedDie] = 2.5, [SixSidedDie] = 3.5, [EightSidedDie] = 4.5, [TenSidedDie] = 5.5, [TwelveSidedDie] = 6.5, [TwentySidedDie] = 10.5, [TwoDTwo] = 3.0, [TwoDThree] = 4.0, [TwoDFour] = 5.0, [TwoDSix] = 7.0,
        };
